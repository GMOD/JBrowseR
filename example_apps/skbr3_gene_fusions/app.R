...
server <- function(input, output, session) {
  # The buttons move the rendered browser without re-running the render
  # expression below.
  observeEvent(input$klhdc2, update_jbrowse("browserOutput", location = "14:50,230,000..50,255,000"))
  observeEvent(input$tatdn1, update_jbrowse("browserOutput", location = "8:125,490,000..125,560,000"))
  observeEvent(input$erbb2, update_jbrowse("browserOutput", location = "17:37,686,000..37,730,000"))

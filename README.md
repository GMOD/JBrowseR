...
<img src="man/figures/demo-marks.png" width="100%" />
...
vignette, or run it on Colab: [![Open In
Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/GMOD/JBrowseR/blob/main/examples/JBrowseR_comparative_colab.ipynb)
...
- [Live embedded
  ...
  — a hub genome, a custom FASTA, an R data frame as a track, and a GWAS
  Manhattan plot
- [Comparing genomes,
  live](https://gmod.github.io/JBrowseR/articles/synteny.html) — a
  linear synteny view and a dotplot

For the Shiny side, [**JBrowseR

...
The hosted hg19 hub carries no reference-name aliases (hg38's does), so
name that assembly yourself with its alias file — otherwise the view only
answers to `chr2` and a track keyed on a bare `2` draws nothing.

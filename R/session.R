...
#'
#' Creates the necessary configuration string for a default
#' session for your browser. A default session is the set
#' of tracks that are displayed when your browser is first
#' displayed.
#'
#' @param assembly the config string generated by \code{assembly}
#' @param displayed_tracks a vector of tracks generated by a \code{track_*} command.
#' @param display_assembly a boolean determining whether the reference sequence is
#'   visible or not. TRUE by default.
#'
#' @export
#'
#' @examples
